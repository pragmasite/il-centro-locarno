  ...
  return (
    <section className="relative min-h-screen overflow-hidden pt-20">
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-primary/90 via-primary to-primary-foreground/5" />
        {/* Accent circles */}
        <motion.div
          animate={{ y: [0, -15, 0] }}
        ...
        <motion.div
          ...
          className="absolute -left-20 bottom-1/4 h-80 w-80 rounded-full bg-primary/20 blur-3xl"
        />
      </div>
      ...
      <div className="container relative mx-auto flex min-h-screen flex-col items-center justify-center px-4 text-center">
        ...
        >
          ...
          >
            <a href="mailto:contatti@ilcentro.ch">
        ...
        <motion.a
          ...
          className="absolute bottom-8 rounded-full border border-white/30 p-3 text-white/60 hover:bg-white/10"
        >
